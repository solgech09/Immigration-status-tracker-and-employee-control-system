...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `registration` SET `biostatus`='$jj',`printing`='$jk' WHERE trackingnumber = $track";
...
<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: black; color:white; height:100px;">
   Collect Biometrics Data and Documents
  </nav>
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style="width:50vw; min-width:300px;">
        ...
        <div class="mb-3">
          ...
          <input type="file" class="form-control" style="width:400px;" name="phone" value="<?php echo $row['phonenumber'] ?>">
        </div>
        <div class="mb-3">
          <label class="form-label">Kebele ID:</label>
          <input type="file" class="form-control" style="width:400px;" name="phone" value="<?php echo $row['phonenumber'] ?>">
        </div>
        <div class="mb-3">
          <label class="form-label">Biometrics Data:</label>
          <input type="file" class="form-control" style="width:400px;" name="phone" value="<?php echo $row['phonenumber'] ?>">
        </div>
       ...
       <br>
        <div class="mb-3">
          ...
          <input type="submit" class="form-control" name="submit" style=" width: 160px; background-color: black; color:white;"value="Ordrer for Print" >
